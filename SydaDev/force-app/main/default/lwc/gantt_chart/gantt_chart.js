...
*/
  ...
  handleRefresh() {
    ...
    getChartData({
        ...
        self.isResourceView = typeof self.objectApiName !== 'undefined' && self.objectApiName.endsWith('IT_Resource__c');
        self.isProjectView = typeof self.objectApiName !== 'undefined' && self.objectApiName.endsWith('IT_Portfolio_Management__c');
        self.isRecordTypeView = typeof self.objectApiName !== 'undefined' && self.objectApiName.endsWith('IT_Portfolio_Management__c');
