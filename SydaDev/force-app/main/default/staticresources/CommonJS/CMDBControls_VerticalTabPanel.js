 ...
 * Modified by Anup Shinde (anup_shinde@bmc.com/www.anupshinde.com)
 */


CMDB.Controls.VerticalTabPanel = function(cfg) {
  if (cfg.tabPosition == 'left' || cfg.tabPosition == 'right') {
    cfg.cls = cfg.cls || '';
    cfg.cls = 'cmdbcontrol-vertical-tabs ' + cfg.cls;
    if (cfg.textAlign && cfg.textAlign == 'right') {
      cfg.cls = 'cmdbcontrol-vertical-tabs-alignright ' + cfg.cls;
    }
    cfg.cls = (cfg.tabPosition == 'left' ? 'cmdbcontrol-vertical-tabs-left ' : 'cmdbcontrol-vertical-tabs-right ') + cfg.cls;
  ...
  CMDB.Controls.VerticalTabPanel.superclass.constructor.call(this, cfg);

};



Ext.extend(CMDB.Controls.VerticalTabPanel, Ext.TabPanel, {
  tabWidth : 150,


  afterRender : function() {
    CMDB.Controls.VerticalTabPanel.superclass.afterRender.call(this);
 ...
 */
  ...
  adjustBodyWidth : function(w) {
    if (this.verticalTabs) {
      ...
      return CMDB.Controls.VerticalTabPanel.superclass.adjustBodyWidth.call(this, w);
    }
  },
 ...
 */
  adjustBodyHeight : function(h) {
    ...
    return CMDB.Controls.VerticalTabPanel.superclass.adjustBodyHeight.call(this, h);
  },
 ...
 */
  getFrameWidth : function() {
    return CMDB.Controls.VerticalTabPanel.superclass.getFrameWidth.call(this) + this.verticalTabs ? this.tabWidth : 0;
  },
 ...
 */
  getFrameHeight : function() {
    return CMDB.Controls.VerticalTabPanel.superclass.getFrameHeight.call(this) - (this.verticalTabs ? this.header.getHeight() : 0);
  },
    ...
    autoScrollTabs : function(){
        if (!this.verticalTabs) {
            CMDB.Controls.VerticalTabPanel.superclass.autoScrollTabs.call(this);
            return;
        }
    ...
    createScrollers : function(){
        if (!this.verticalTabs) {
            CMDB.Controls.VerticalTabPanel.superclass.createScrollers.call(this);
            return;
        }
    ...
    getScrollPos : function(){
        if (!this.verticalTabs) {
            return CMDB.Controls.VerticalTabPanel.superclass.getScrollPos.call(this);
        }
    ...
    getScrollArea : function(){
        if (!this.verticalTabs) {
            return CMDB.Controls.VerticalTabPanel.superclass.getScrollArea.call(this);
        }
    ...
    updateScrollButtons : function(){
        if (!this.verticalTabs) {
            CMDB.Controls.VerticalTabPanel.superclass.updateScrollButtons.call(this);
            return;
        }
    ...
    scrollTo : function(pos, animate){
        if (!this.verticalTabs) {
            CMDB.Controls.VerticalTabPanel.superclass.scrollTo.call(this, pos, animate);
            return;
        }
