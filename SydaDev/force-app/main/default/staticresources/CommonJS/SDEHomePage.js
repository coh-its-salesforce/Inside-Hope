		 ...
		 if((linkArray[n.attributes.pageRef]) == null ){
			 ...
			 title: ' &nbsp;&nbsp; '+n.text,
			   ...
			   domId:n.attributes.domId,
				...
				html: '<div class=\"iframe-enclave1\" id=\"divId'+n.id+'\"><\/div><div class=\"iframe-enclave\"><iframe id="skyiframe'+mod+'" name="skyiframe'+mod+'" src =\"\/apex\/'+encodeURI(pageRef)+'\" class=\"tab-iframe\"/></div>',
				closable : true,
				listeners : {
...
Ext.onReady(function() {
	...
	new Ext.Viewport({
		...
		{
			region: 'north',
			html: '<div class="header-div" width="100%"><table width="100%" ><tr><td align="left" width="425px" ><iframe bgcolor="#334f67;"  allowTransparency="true" frameborder="0" style="height:35px;" src =\"\/apex\/DisplayLogo\" width="100%" scrolling=NO></iframe></td><td width="600px" bgcolor="#334f67" style="height:35px;background:#334f67;overflow:hidden"><iframe bgcolor="#334f67;" frameborder="0" src =\"\/apex\/TickerPage\" width="100%"  style="height:35px;background:#334f67;overflow:hidden;overflow:auto\9;" allowTransparency="true" /></iframe></td><td width="250px" valign="top" align="right" class="homeStyle homeStyleUser">'+labelWelcome+',&nbsp;'+userName+'</td><td valign="top" width="5%" style="height:35px;" align="left" class="bgtop homeStyle"><a class="homeStyle" style="white-space:nowrap;" id="homelink" href="#nogo" onmousedown=\"confirm(event);\">'+labelSetup+'</a><a id="helpMenuLink" class="homeStyle" style="cursor:pointer;white-space:nowrap;">'+labelHelp+'</a><a class="homeStyle" style="white-space:nowrap;" id="logoutHomeLink" href="/secur/logout.jsp">'+labelLogout+'</a></td></tr></table></div>',
			autoHeight: true,
			border: false,
			margins: '-3 0 3 -2'
			...
			items: [{
				...
				expanded: true,
				children: navigatorJsonFeedRoot()
			   })
				,rootVisible: false,
				plugins: {
					init: clickFunction
	...
	function gettingStarted(){
		if(userLanguage =='ja'){
	     window.open(resSDEFStylesPath_JA+"/GettingStarted.pdf","popUpWindow","height=700,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes");
	   }
	   else{
	...
	function showContactUs()
	{
		...
		//var NewHtml = Ext.getDom('contactus').innerHTML;
	...
	function showAbout()
	{
		...
		//var NewHtml = Ext.getDom('aboutus').innerHTML;
