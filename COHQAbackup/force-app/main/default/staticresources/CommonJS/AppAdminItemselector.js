...
Ext.ux.form.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    up : function() {
		var imagesource = document.getElementById('iconUpId').src;
		if(!(imagesource.indexOf('b_darrow_U_disable_custom') > 0)){
			var record = null;
			var selectionsArray = this.toMultiselect.view.getSelectedIndexes();
			selectionsArray.sort();
			...
			var newIndex = this.toMultiselect.view.getSelectedIndexes();
			if(newIndex == 0){
				document.getElementById('iconUpId').src = this.imagePath+'b_darrow_U_disable_custom.gif'
				document.getElementById('iconDownId').src = this.imagePath+'b_darrow_D_new.gif'
			} else if(newIndex == this.toMultiselect.view.store.data.length-1){
				document.getElementById('iconUpId').src = this.imagePath+'b_darrow_U_new.gif'
				document.getElementById('iconDownId').src = this.imagePath+'b_darrow_D_disable_custom.gif'			
			} else {
				document.getElementById('iconUpId').src = this.imagePath+'b_darrow_U_new.gif'
				document.getElementById('iconDownId').src = this.imagePath+'b_darrow_D_new.gif'						
			}
    ...
    down : function() {
		var imagesource = document.getElementById('iconDownId').src;
		if(!(imagesource.indexOf('b_darrow_D_disable_custom') > 0)){
			var record = null;
			var selectionsArray = this.toMultiselect.view.getSelectedIndexes();
			selectionsArray.sort();
    ...
    fromTo : function() {
		var imagesource = document.getElementById('iconRightId').src;
		if(!(imagesource.indexOf('b_darrow_R_disable_custom.gif') > 0)){
			...
			this.toMultiselect.view.select(selectionsArray);	
			document.getElementById('iconRightId').src = this.imagePath+'b_darrow_R_disable_custom.gif';
			document.getElementById('iconLeftId').src = this.imagePath+'b_darrow_L_new.gif';
			document.getElementById('iconUpId').src = this.imagePath+'b_darrow_U_new.gif';
			document.getElementById('iconDownId').src = this.imagePath+'b_darrow_D_disable_custom.gif';
		}
    },
    ...
    toFrom : function() {
		var imagesource = document.getElementById('iconLeftId').src;
		if(!(imagesource.indexOf('b_darrow_L_disable_custom.gif') > 0)){	
			var selectionsArray = this.toMultiselect.view.getSelectedIndexes();
			var records = [];
			if (selectionsArray.length > 0) {
			...
			document.getElementById('iconRightId').src = this.imagePath+'b_darrow_R_new.gif';
			document.getElementById('iconLeftId').src = this.imagePath+'b_darrow_L_disable_custom.gif';
			document.getElementById('iconUpId').src = this.imagePath+'b_darrow_U_disable_custom.gif';
			document.getElementById('iconDownId').src = this.imagePath+'b_darrow_D_disable_custom.gif';
		}
    },
