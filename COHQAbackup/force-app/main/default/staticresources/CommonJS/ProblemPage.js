...
var NewBtnHandler = function(button,event) { 
	openPage("ProblemPage",ProblemRequestHeader,ProblemRequestHeader); activeAllWindowFlag=false;
...
function setWorkAroundEnableDisable(){
  if( document.getElementById(ProblemPageComp.ComponentVars.ProblemFormKnowError).checked == false){
...
function displayTextEditor(){
	var isChecked=document.getElementById(ProblemPageComp.ComponentVars.ProblemFormKnowError).checked;
