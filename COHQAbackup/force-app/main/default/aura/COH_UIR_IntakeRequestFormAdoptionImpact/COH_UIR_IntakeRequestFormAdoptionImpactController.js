({
    ...
    validateFields: function(component, event, helper) {
        ...
        if (validity) {
            component.set('v.mIntakeRequest.COH_UIR_SHR_WhichDeptsAdoptionImpact__c', checkboxGroupHelper.jsonArrayToMultipleSelectPicklist(component.get('v.mCheckboxGroupValues.COH_UIR_SHR_WhichDeptsAdoptionImpact__c')));
        }
