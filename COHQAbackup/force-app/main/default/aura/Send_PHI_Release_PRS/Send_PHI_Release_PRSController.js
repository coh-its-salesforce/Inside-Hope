({
     ...
     * 
     */
    sendPHIRelease : function(component, event) {
        var action = component.get('c.getcase');
        ...
        action.setCallback(this, function(response) {
            ...
            if (responseState === 'SUCCESS') {
                ...
                if (cas != null) {
                    ...
                    CES="City of Hope PHI Release For Signature"; 
                   // DST="0367A628-AD0A-4483-9F0E-8A5F58FF3DD3"; 
                    ...
                    helper.showToast("Error: PHI Release not sent", "error", "Case record could not be retrieved. It may have been deleted by another user. Case ID: " + caseRecID);                
                }
                ...
                helper.showToast("Error: PHI Release not sent", "error", "An error occurred while attempting to send the PHI release: " + message);                
            }
        });
        $A.enqueueAction(action);
    },
