({
     ...
     * 
     */
    sendPatientInfoPacket: function(component, event) {
        var action = component.get('c.getcase');
        ...
        action.setCallback(this, function(response) {
            ...
            if (responseState === 'SUCCESS') {
                ...
                if (cas != null) {
                    ...
                    CES="City of Hope Patient Information Packet For Signature"; 
                    /*Added by Sanjay Singh 9/13/2022, Added the DocuSign document id*/
                    DST="b55c30e8-5468-4355-ad25-ddfd57b7baa9"; 
                    OCO = 'Send'; 
                    CCRM='Role1~Patient'; 
                    ...
                    helper.showToast("Error: Patient Info Packet", "error", "Case record could not be retrieved. It may have been deleted by another user. Case ID: " + caseRecID);                
                }
                ...
                helper.showToast("Error: Patient Info Packet not sent", "error", "An error occurred while attempting to send the PHI release: " + message);                
            }
        });
        $A.enqueueAction(action);
    },
