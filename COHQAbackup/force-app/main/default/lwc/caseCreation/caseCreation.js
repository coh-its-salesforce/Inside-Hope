    ...
    getcases(recordId){
        ...
        .then(results=>{
            ...
            for(var i=0 ;i <results.length;i++){
                ...
                if(results[i].RecordType == null){
                    results[i].recordtypeName = '';
                }else{
                    results[i].recordtypeName = results[i].RecordType.Name;
                }
            }
            this.casesList = results;
            console.log('case list***' + JSON.stringify(this.casesList ));
