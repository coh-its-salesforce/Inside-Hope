...
import getChartData from "@salesforce/apex/ganttChartRM.getChartData";
import getProjects from "@salesforce/apex/ganttChartRM.getProjects";
import getResources from "@salesforce/apex/ganttChartRM.getResources";

export default class GanttChartRM extends NavigationMixin(LightningElement) {
  url;
  @api recordId = "";
  @api objectApiName;
  ...
  connectedCallback() {
    ...
    this.teamAssignmentNewPageRef={
      type: 'standard__objectPage',
      attributes: {
        objectApiName: 'Team_Assignment__c',
        actionName: 'new'
      }
    };
    this[NavigationMixin.GenerateUrl](this.teamAssignmentNewPageRef).then(url => this.url = url);
  }
  ...
  setDateHeaders() {
    ...
    Array.from(
      this.template.querySelectorAll("c-gantt_chart_resource_r_m")
    ).forEach(resource => {
...
*/
  ...
  navigateNewAssignment(evt){
    this[NavigationMixin.Navigate](this.teamAssignmentNewPageRef);
  }
  /*** /Filter Modal ***/
  ...
  handleRefresh() {
    ...
    getChartData({
        ...
        self.isProjectView = typeof self.objectApiName !== 'undefined' && self.objectApiName.endsWith('IT_Resource__c');
        self.isRecordTypeView = typeof self.objectApiName !== 'undefined' && self.objectApiName.endsWith('IT_Resource__c');
